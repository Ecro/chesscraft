...
content_hash: 5812a60dad853859dba1def9c2e5ef66468fd36b229fb80a1af2dda2ae92912c
---
...
- **`feature`** (default): one discrete feature per iteration. Executor = the configured `--per-iter-stages` sequence; convergence = named predicate.
