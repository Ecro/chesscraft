...
content_hash: 7431852978e7ea7dc850d117d424285d86181a156464b0f51110841b8b73fd73
---
...
```bash
!uv run --with $HOME/.claude/plugins/cache/harness-maker/harness-maker/0.47.0 python -m harness_maker.cli security-scan .
```
