...
content_hash: d754624c29195a7558460f190f41ee0f89fe7e837b277f7929d12402d18c6495
---
...
```bash
!uv run --with $HOME/.claude/plugins/cache/harness-maker/harness-maker/0.52.0 python -m harness_maker.cli security-scan .
```
