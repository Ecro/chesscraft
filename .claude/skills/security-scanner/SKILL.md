...
content_hash: d53fe6eeac3adb683fcab8d01a7c49568126bf6b0a204d60ab920c24571580db
---
...
```bash
!uv run --with $HOME/.claude/plugins/cache/harness-maker/harness-maker/0.57.1 python -m harness_maker.cli security-scan .
```
