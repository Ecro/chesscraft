...
content_hash: f5040e7d1ec6cae26591e46e5a5642a399fb5111636fa4a25d64e63ff7321419
---
...
```bash
!uv run --with $HOME/.claude/plugins/cache/harness-maker/harness-maker/0.54.0 python -m harness_maker.cli security-scan .
```
