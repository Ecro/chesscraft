...
content_hash: 741ed9b2e694fdf16f1ab3d9256612431f3f7b53a341aa46eee5c245b52a79fb
---
...
```bash
!uv run --with $HOME/.claude/plugins/cache/harness-maker/harness-maker/0.51.0 python -m harness_maker.cli security-scan .
```
