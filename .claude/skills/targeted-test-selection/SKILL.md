...
content_hash: 9c4dd4877482336b9493cc5a3168fc3c2a778c916a99feb7c69b571e7c5afb25
---
...
```bash
uv run --with $HOME/.claude/plugins/cache/harness-maker/harness-maker/0.54.1 hm test_runners plan --root .
```
...
```bash
cd <the task worktree> && uv run --with $HOME/.claude/plugins/cache/harness-maker/harness-maker/0.54.1 hm test_dep_map --root . --changed-file='<f1>' --changed-file='<f2>' …
```
