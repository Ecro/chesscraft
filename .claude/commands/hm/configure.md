...
content_hash: 7ec2e8c4245bdcaf898b217113f34432ec9817a5f5f43910877971e7b4a707d3
---
# /hm:configure
...
```bash
!uv run --with $HOME/.claude/plugins/cache/harness-maker/harness-maker/0.57.1 hm cli detect-tools --json
```
...
```bash
!uv run --with $HOME/.claude/plugins/cache/harness-maker/harness-maker/0.57.1 hm cli \
...
```bash
!uv run --with $HOME/.claude/plugins/cache/harness-maker/harness-maker/0.57.1 hm cli make "$(pwd)" \
