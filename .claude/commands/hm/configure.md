...
content_hash: b94377bfdd5dc7144b364ca7fdcbc99630804fe77f1f4c221bc5108c4db7f69c
---
# /hm:configure
...
```bash
!uv run --with $HOME/.claude/plugins/cache/harness-maker/harness-maker/0.52.6 hm cli detect-tools --json
```
...
```bash
!uv run --with $HOME/.claude/plugins/cache/harness-maker/harness-maker/0.52.6 hm cli \
...
```bash
!uv run --with $HOME/.claude/plugins/cache/harness-maker/harness-maker/0.52.6 hm cli make "$(pwd)" \
