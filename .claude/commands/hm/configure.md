...
content_hash: 010e8b668030d2de058e4b41642703ffed0054a6dde9bd3ee700bb4aef85b115
---
# /hm:configure
...
```bash
!uv run --with $HOME/.claude/plugins/cache/harness-maker/harness-maker/0.52.5 hm cli detect-tools --json
```
...
```bash
!uv run --with $HOME/.claude/plugins/cache/harness-maker/harness-maker/0.52.5 hm cli \
...
```bash
!uv run --with $HOME/.claude/plugins/cache/harness-maker/harness-maker/0.52.5 hm cli make "$(pwd)" \
