...
content_hash: d846e371e7ec600fa80534016077f28de275774fa4ecdc55be801d2f930f5b91
---
# /hm:configure
...
```bash
!uv run --with $HOME/.claude/plugins/cache/harness-maker/harness-maker/0.52.1 hm cli detect-tools --json
```
...
```bash
!uv run --with $HOME/.claude/plugins/cache/harness-maker/harness-maker/0.52.1 hm cli \
...
```bash
!uv run --with $HOME/.claude/plugins/cache/harness-maker/harness-maker/0.52.1 hm cli make "$(pwd)" \
