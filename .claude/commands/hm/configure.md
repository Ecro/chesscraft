...
content_hash: 94d425fd55deea826ef306134654b5e30388adbd8ce217cb13e8357caf708ca8
---
# /hm:configure
...
```bash
!uv run --with $HOME/.claude/plugins/cache/harness-maker/harness-maker/0.52.4 hm cli detect-tools --json
```
...
```bash
!uv run --with $HOME/.claude/plugins/cache/harness-maker/harness-maker/0.52.4 hm cli \
...
```bash
!uv run --with $HOME/.claude/plugins/cache/harness-maker/harness-maker/0.52.4 hm cli make "$(pwd)" \
