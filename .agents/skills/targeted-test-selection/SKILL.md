...
content_hash: b094399c3159e058b907bac234754621a44373a208d971cb635894c0d52a2dfb
---
...
```bash
uv run --with $HOME/.claude/plugins/cache/harness-maker/harness-maker/0.55.0 hm test_runners plan --root .
```
...
```bash
cd <the task worktree> && uv run --with $HOME/.claude/plugins/cache/harness-maker/harness-maker/0.55.0 hm test_dep_map --root . --changed-file='<f1>' --changed-file='<f2>' …
```
