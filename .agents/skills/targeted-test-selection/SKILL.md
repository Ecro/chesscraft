...
content_hash: e0c6d716c0f77a4f9a0b744374d96e0c7a9cf360d1494d6715dc142bf45c3ce0
---
...
```bash
uv run --with $HOME/.claude/plugins/cache/harness-maker/harness-maker/0.57.1 hm test_runners plan --root .
```
...
```bash
cd <the task worktree> && uv run --with $HOME/.claude/plugins/cache/harness-maker/harness-maker/0.57.1 hm test_dep_map --root . --changed-file='<f1>' --changed-file='<f2>' …
```
