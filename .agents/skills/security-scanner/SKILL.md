...
content_hash: ec697fb9d3e38f9a3f823009b02b4423f861e9a54e5ba86a5f005b5660fe3559
---
...
```bash
!uv run --with $HOME/.claude/plugins/cache/harness-maker/harness-maker/0.52.1 python -m harness_maker.cli security-scan .
```
