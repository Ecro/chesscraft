...
content_hash: d55e338a7a1e3c2cfff70f58b0b2763de81ad8c8588a00d22a386340af1e83bc
---
...
```bash
!uv run --with $HOME/.claude/plugins/cache/harness-maker/harness-maker/0.52.6 python -m harness_maker.cli security-scan .
```
