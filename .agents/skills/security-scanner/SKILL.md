...
content_hash: 8bdc09f2b38589ffd29d2443356f7af32a8ba35a665d9eeff963c32673a52d9f
---
...
```bash
!uv run --with $HOME/.claude/plugins/cache/harness-maker/harness-maker/0.51.1 python -m harness_maker.cli security-scan .
```
