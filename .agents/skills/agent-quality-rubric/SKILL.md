...
content_hash: e5dadea213e69875c4674374b03d74ec0073de4bbd339e9da38e3a64e6e2cdcb
---
...
```bash
!uv run --with $HOME/.claude/plugins/cache/harness-maker/harness-maker/0.54.1 python -c "
