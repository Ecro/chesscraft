...
test('authored content is playable in the same session', async ({ page }) => {
  ...
  await page.getByTestId('board-mode-paint').click()
  await page.getByTestId('board-paint-pick-square.quicksand').click()
  await page.getByTestId('board-paint-d3').click()
  await save(page)
...
test.describe('piece axis', () => {
  test('creates a piece with the visual movement grid and places it on the board', async ({ page }) => {
    ...
    await page.getByTestId('board-place-side-white').click()
    await page.getByTestId('board-place-pick-piece.hopper').click()
    await page.getByTestId('board-place-a3').click()
    await save(page)
...
test.describe('special-square axis', () => {
  test('creates a standalone square type, paints it, and the board shows it', async ({ page }) => {
    ...
    await page.getByTestId('library-open-board.slice').click()
    await page.getByTestId('board-mode-paint').click()
    await page.getByTestId('board-paint-pick-square.lava').click()
    await page.getByTestId('board-paint-e5').click()
    await save(page)
...
test.describe('board axis', () => {
  test('creates a board with painted squares and a preset that plays on it', async ({ page }) => {
    ...
    await page.getByTestId('board-mode-place').click()
    await page.getByTestId('board-place-side-white').click()
    await page.getByTestId('board-place-pick-piece.king').click()
    await page.getByTestId('board-place-a1').click()
    await page.getByTestId('board-place-side-black').click()
    await page.getByTestId('board-place-a6').click()
    await page.getByTestId('board-mode-paint').click()
    await page.getByTestId('board-paint-pick-square.beacon').click()
    await page.getByTestId('board-paint-d4').click()
    await save(page)
