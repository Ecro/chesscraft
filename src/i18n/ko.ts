...
export const ko: Record<string, string> = {
  ...
  'ui.piece-info.turning': '{first}으로 간 뒤 {second}로 꺾어서 {reach}',
  ...
  'ui.editor.turning.move': '움직일 때 꺾기',
  'ui.editor.turning.capture': '잡을 때 꺾기',
  'ui.editor.turning.hint': '첫 방향으로 한 칸 이상 간 뒤, 두 번째 방향으로 꺾어 계속 가요. 한 번만 꺾어요.',
  'ui.editor.turning.first': '첫 방향',
  'ui.editor.turning.second': '꺾는 방향',
  'ui.editor.turning.reach': '전체 거리',
  'ui.editor.turning.edge': '끝까지',
  'ui.editor.turning.add': '꺾임 더하기',
  'ui.editor.turning.remove': '이 꺾임 지우기',
  'ui.editor.turning.unsupported': '이 꺾임은 현재 편집기에서 그대로 보존되며 수정할 수 없어요.',
  'ui.editor.piece.summary.turning-only': '{turns}갈래로 꺾어 간다. 잡을 수 있는 꺾임은 {takes}갈래.',
  'ui.editor.piece.summary.turning-both': '{turns}갈래로 꺾어 가고, {moves}곳으로 뛴다. 잡을 수 있는 꺾임은 {takes}갈래.',
  'ui.editor.piece.summary.turning-summary': '{turns}갈래로 꺾어서 가요. 잡을 수 있는 꺾임은 {takes}갈래.',
