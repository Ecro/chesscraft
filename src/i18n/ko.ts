...
export const ko: Record<string, string> = {
  ...
  'piece.pawn-plus.name': '재빠른 병사',
  'piece.pawn-plus.text': '앞으로 한 칸 또는 옆으로 한 칸 움직인다. 잡을 때는 병사처럼 대각선 앞으로만 잡는다.',
  'piece.knight-plus.name': '기동 기사',
  'piece.knight-plus.text': '기사처럼 뛰거나 상하좌우로 한 칸 움직인다. 한 칸 움직임으로는 잡을 수 없다.',
  'piece.bishop-plus.name': '기동 비숍',
  'piece.bishop-plus.text': '대각선으로 쭉 가거나 상하좌우로 한 칸 움직인다. 한 칸 움직임으로는 잡을 수 없다.',
  'piece.rook-plus.name': '기동 성',
  'piece.rook-plus.text': '가로세로로 쭉 가거나 대각선으로 한 칸 움직인다. 대각선 움직임으로는 잡을 수 없다.',
  'piece.pawn-scout.name': '정찰 병사',
  'piece.pawn-scout.text': '앞으로 한 칸 또는 대각선 앞으로 한 칸 움직인다. 잡을 때는 대각선 앞으로만 잡는다. 끝줄에 닿으면 여왕이 된다.',
  'piece.pawn-retreat.name': '후퇴 병사',
  'piece.pawn-retreat.text': '앞이나 뒤로 한 칸 움직인다. 잡을 때는 대각선 앞으로만 잡는다. 끝줄에 닿으면 여왕이 된다.',
  'piece.knight-diagonal.name': '사선 기사',
  'piece.knight-diagonal.text': '기사처럼 뛰거나 대각선으로 한 칸 움직인다. 대각선 한 칸 움직임으로는 잡을 수 없다.',
  'piece.knight-spring.name': '도약 기사',
  'piece.knight-spring.text': '기사처럼 뛰거나 상하좌우로 두 칸 뛴다. 사이의 기물을 넘을 수 있지만, 새 두 칸 도약으로는 잡을 수 없다.',
  'piece.bishop-spring.name': '도약 비숍',
  'piece.bishop-spring.text': '대각선으로 쭉 가거나 상하좌우로 두 칸 뛴다. 도약은 사이의 기물을 넘지만 상대를 잡을 수 없다.',
  'piece.bishop-scout.name': '정찰 비숍',
  'piece.bishop-scout.text': '대각선으로 쭉 가거나 앞으로 두 칸, 옆으로 한 칸인 곳으로 뛴다. 도약은 사이의 기물을 넘지만 상대를 잡을 수 없다.',
  'piece.rook-spring.name': '도약 성',
  'piece.rook-spring.text': '가로세로로 쭉 가거나 대각선으로 두 칸 뛴다. 도약은 사이의 기물을 넘지만 상대를 잡을 수 없다.',
  'piece.rook-scout.name': '정찰 성',
  'piece.rook-scout.text': '가로세로로 쭉 가거나 앞으로 두 칸, 옆으로 한 칸인 곳으로 뛴다. 도약은 사이의 기물을 넘지만 상대를 잡을 수 없다.',
  ...
  'ui.editor.loadout.square': '바꿀 시작 칸',
  ...
  'ui.editor.vocab.movement.turning_slide': '꺾어서 미끄러지기',
  ...
  'ui.lobby.start': '시작!',
  'ui.equipment.title': '획득한 기물 장착',
  'ui.equipment.upgrade': '이번 판에 쓸 기물',
  'ui.equipment.square': '바꿀 시작 칸',
  'ui.equipment.room-default': '방의 기본 기물',
  'ui.equipment.room-piece': '획득 기물을 고르면 방에서 만든 기물 대신 그 한 칸에만 사용해요.',
  'ui.equipment.stars': '기본 {canonical} · 이 방 {room} · 방 한도 {budget}',
  'ui.equipment.refused.not-owned': '아직 갖고 있지 않은 기물이라 방의 기본값을 사용해요.',
  'ui.equipment.refused.invalid-upgrade': '이 기물 정보가 바뀌어 방의 기본값을 사용해요.',
  'ui.equipment.refused.invalid-square': '저장한 시작 칸이 이 방에 없어 방의 기본값을 사용해요.',
  'ui.equipment.refused.room-piece-conflict': '방 기물과 획득 기물을 함께 적용할 수 없어요.',
  'ui.eligibility.standard': '스탠다드 대국 · 불꽃을 받을 수 있어요.',
  'ui.eligibility.sandbox': '샌드박스 대국 · 불꽃은 받지 않아요.',
  'ui.eligibility.reason.legacy-replace-all-loadout': '예전 방식의 전체 교체 설정이에요.',
  'ui.eligibility.reason.curated-upgrade-requires-owned-equipment': '획득 기물이 방에 직접 놓여 있어요.',
  'ui.eligibility.reason.authored-piece-over-ceiling': '사람이 만든 기물이 표준 세기 한도를 넘어요.',
  'ui.eligibility.reason.invalid-effective-equipment': '장착한 기물을 이 방에 적용할 수 없어요.',
  'ui.eligibility.reason.loadout-grade-or-budget-invalid': '방의 교체 기물이나 카드가 별 한도에 맞지 않아요.',
  'ui.progression.sparks': '불꽃 {count}개',
  'ui.progression.region': '강화 기물 획득',
  'ui.progression.granted': '대국을 마쳐 불꽃 1개를 받았어요.',
  'ui.progression.save-failed': '획득 기록을 저장하지 못했어요. 가진 내용은 바뀌지 않았어요.',
  'ui.progression.retry': '다시 저장하기',
  'ui.progression.storage-failed': '획득 기록을 안전하게 불러오거나 저장하지 못했어요. 확인할 때까지 변경하지 않아요.',
  'ui.progression.storage-reload': '획득 기록 다시 불러오기',
  'ui.progression.sandbox': '이 샌드박스 대국에서는 불꽃을 받지 않아요.',
  'ui.progression.reveal': '불꽃 {cost}개로 기물 후보 보기',
  'ui.progression.offer': '하나를 골라 내 기물로 만드세요.',
  'ui.progression.backup.title': '획득 기록 백업',
  'ui.progression.backup.label': '획득 기록 백업 글자',
  'ui.progression.backup.export': '백업 글자 만들기',
  'ui.progression.backup.restore': '백업으로 되돌리기',
  'ui.progression.backup.confirm': '지금의 불꽃, 획득 기물, 장착 기록을 백업 내용으로 모두 바꿀까요?',
  'ui.upgrade.family': '이 기물의 강화',
  'ui.upgrade.family-choice': '강화형 골라 보기',
  'ui.upgrade.region': '{name} 강화',
  'ui.upgrade.move-preview': '추가 이동:',
  'ui.upgrade.owned': '가지고 있어요',
  'ui.upgrade.unowned': '아직 없어요',
  'ui.upgrade.forge': '불꽃 {cost}개로 바로 만들기',
  'ui.progression.how': '일반 대국을 마치면 승패와 관계없이 불꽃 1개! 천천히 모아도 사라지지 않아요.',
  'ui.progression.goal.reveal': '{cost}개 · 후보를 보고 하나 고르기',
  'ui.progression.goal.forge': '{cost}개 · 원하는 기물 바로 만들기',
  'ui.progression.ready': '준비됐어요!',
  'ui.progression.remaining': '불꽃 {count}개 더 모으면 돼요.',
  'ui.progression.complete': '강화 기물 친구들을 모두 모았어요! 무료 연습으로 새 작전을 찾아보고, 대국 준비에서 써 보세요.',
  'ui.progression.offer-count': '후보 {count}개',
  'ui.progression.keep-offer': '그림과 움직임을 살펴보고 골라요. 지금 떠나도 후보는 도감에 그대로 있어요.',
  'ui.progression.choose': '{name} 데려오기',
  'ui.upgrade.acquired': '{name}, 내 수집판에 합류!',
  'ui.upgrade.equip-next': '대국 준비 → 강화 기물에서 기물과 시작 칸을 골라요. 한쪽에 한 칸만 바뀌어요.',
  'ui.upgrade.album': '나의 강화 기물 수집판',
  'ui.upgrade.album-count': '모은 친구 {owned} / {total}',
  'ui.upgrade.album-hint': '아직 없는 친구도 눌러서 무료로 연습해 보세요. 원하는 친구를 바로 만들 수도 있어요.',
  'ui.upgrade.style.piece.pawn-plus': '옆길로 빠져나가는 작은 모험가',
  'ui.upgrade.style.piece.knight-plus': '큰 점프에 작은 발걸음까지',
  'ui.upgrade.style.piece.bishop-plus': '대각선 길 사이로 한 발짝',
  'ui.upgrade.style.piece.rook-plus': '직진하다 살짝 대각선으로',
  'ui.upgrade.style.piece.pawn-scout': '빈 대각선으로 먼저 나아가는 정찰대',
  'ui.upgrade.style.piece.pawn-retreat': '한 발 물러나 다음 기회를 준비해요',
  'ui.upgrade.style.piece.knight-diagonal': '큰 점프 뒤에는 비스듬한 한 발짝',
  'ui.upgrade.style.piece.knight-spring': '막힌 길을 넘는 십자 점프',
  'ui.upgrade.style.piece.bishop-spring': '대각선 길에서 두 칸 건너뛰기',
  'ui.upgrade.style.piece.bishop-scout': '앞쪽의 새로운 색 칸을 찾아요',
  'ui.upgrade.style.piece.rook-spring': '성벽 너머로 비스듬히 폴짝',
  'ui.upgrade.style.piece.rook-scout': '직선 길을 벗어나 앞쪽 틈새로',
  'ui.practice.try': '무료로 움직여 보기',
  'ui.practice.hide': '연습 접기',
  'ui.practice.region': '강화 기물 무료 연습',
  'ui.practice.context': '공식 기물 · 흰색 · 빈칸으로 한 번 이동하는 연습이에요. 불꽃과 소유 기록은 바뀌지 않아요.',
  'ui.practice.base': '기본 기물',
  'ui.practice.upgrade': '강화 기물',
  'ui.practice.legend': '· 기본 이동 / ★ 새 이동 / ♚ 왕의 자리. 잡는 방법은 기물 설명을 확인하세요.',
  'ui.practice.board': '6×6 이동 연습판',
  'ui.practice.cell.piece': '내 기물',
  'ui.practice.cell.king': '왕의 자리',
  'ui.practice.cell.added': '새 이동',
  'ui.practice.cell.ordinary': '기본 이동',
  'ui.practice.cell.unavailable': '갈 수 없는 칸',
  'ui.practice.prompt': '별 칸을 눌러 새 이동을 발견해 보세요. 기본 기물과 비교해도 좋아요.',
  'ui.practice.success': '새 이동 발견! 이 한 발짝으로 어떤 작전을 만들 수 있을까요?',
  'ui.practice.ordinary': '기본 기물도 할 수 있는 이동이에요. 다시 놓고 별 칸도 찾아보세요.',
  'ui.practice.reset': '다시 놓고 해 보기',
  ...
  'ui.piece-info.turning-auto': '{dirs} 방향은 바깥칸에서 두 번 누르면 자동으로 꺾여요.',
  ...
  'ui.editor.piece.how-hint': '가운데가 이 기물이에요. 칸을 누르면 안 감 → 뛰어감 → 미끄러짐으로 바뀌어요. 미끄러짐은 가는 길의 기물에서 멈춰요. 맨 바깥 칸을 빠르게 두 번 누르면 그 방향으로 미끄러지다가 알맞은 방향으로 한 번 자동으로 꺾여요.',
  ...
  'ui.editor.piece.preserved-pattern': '이 복잡한 움직임은 그대로 보존되며, 이 상자에서는 바꿀 수 없어요.',
  ...
  'ui.editor.piece.summary.turning-auto-summary': '{turns}갈래가 자동으로 꺾어서 가요. 잡을 때 자동 꺾임은 {takes}갈래.',
  'ui.editor.piece.summary.preserved': '복잡한 움직임 {count}개는 원래대로 보존돼요.',
