...
export const bundledContentSource: ContentSource = {
  ...
  pieces: [
    ...
    {
      id: 'piece.pawn-scout',
      nameKey: 'piece.pawn-scout.name',
      textKey: 'piece.pawn-scout.text',
      artKey: 'art.pawn-plus',
      movement: [{ kind: 'step', vectors: [[0, 1], [1, 1], [-1, 1]], forward: true }],
      attack: [{ kind: 'step', vectors: [[1, 1], [-1, 1]], forward: true }],
      promotion: { onRank: 'last', to: 'piece.queen' },
      effects: [],
    },
    {
      id: 'piece.pawn-retreat',
      nameKey: 'piece.pawn-retreat.name',
      textKey: 'piece.pawn-retreat.text',
      artKey: 'art.pawn-plus',
      movement: [{ kind: 'step', vectors: [[0, 1], [0, -1]], forward: true }],
      attack: [{ kind: 'step', vectors: [[1, 1], [-1, 1]], forward: true }],
      promotion: { onRank: 'last', to: 'piece.queen' },
      effects: [],
    },
    {
      id: 'piece.knight-diagonal',
      nameKey: 'piece.knight-diagonal.name',
      textKey: 'piece.knight-diagonal.text',
      artKey: 'art.knight-plus',
      movement: [{ kind: 'jump', vectors: KNIGHT }, { kind: 'step', vectors: DIAGONAL }],
      attack: [{ kind: 'jump', vectors: KNIGHT }],
      effects: [],
    },
    {
      id: 'piece.knight-spring',
      nameKey: 'piece.knight-spring.name',
      textKey: 'piece.knight-spring.text',
      artKey: 'art.knight-plus',
      movement: [{ kind: 'jump', vectors: KNIGHT }, { kind: 'jump', vectors: [[2, 0], [-2, 0], [0, 2], [0, -2]] }],
      attack: [{ kind: 'jump', vectors: KNIGHT }],
      effects: [],
    },
    {
      id: 'piece.bishop-spring',
      nameKey: 'piece.bishop-spring.name',
      textKey: 'piece.bishop-spring.text',
      artKey: 'art.bishop-plus',
      movement: [{ kind: 'slide', vectors: DIAGONAL }, { kind: 'jump', vectors: [[2, 0], [-2, 0], [0, 2], [0, -2]] }],
      attack: [{ kind: 'slide', vectors: DIAGONAL }],
      effects: [],
    },
    {
      id: 'piece.bishop-scout',
      nameKey: 'piece.bishop-scout.name',
      textKey: 'piece.bishop-scout.text',
      artKey: 'art.bishop-plus',
      movement: [{ kind: 'slide', vectors: DIAGONAL }, { kind: 'jump', vectors: [[1, 2], [-1, 2]], forward: true }],
      attack: [{ kind: 'slide', vectors: DIAGONAL }],
      effects: [],
    },
    {
      id: 'piece.rook-spring',
      nameKey: 'piece.rook-spring.name',
      textKey: 'piece.rook-spring.text',
      artKey: 'art.rook-plus',
      movement: [{ kind: 'slide', vectors: ORTHOGONAL }, { kind: 'jump', vectors: DIAGONAL_TWO }],
      attack: [{ kind: 'slide', vectors: ORTHOGONAL }],
      effects: [],
    },
    {
      id: 'piece.rook-scout',
      nameKey: 'piece.rook-scout.name',
      textKey: 'piece.rook-scout.text',
      artKey: 'art.rook-plus',
      movement: [{ kind: 'slide', vectors: ORTHOGONAL }, { kind: 'jump', vectors: [[1, 2], [-1, 2]], forward: true }],
      attack: [{ kind: 'slide', vectors: ORTHOGONAL }],
      effects: [],
    },
    {
